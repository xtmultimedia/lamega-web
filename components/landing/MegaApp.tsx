...
import { Icon, Section, Bloom } from "@/components/ui";
    ...
    >
      {isPlay ? (
        <svg width="24" height="24" viewBox="0 0 24 24">
          <path d="M3.6 2.3 13 12l-9.4 9.7c-.3-.2-.6-.6-.6-1.2V3.5c0-.6.3-1 .6-1.2Z" fill="#00D9FF" />
          <path d="m13 12 3.1-3.2 4.6 2.6c.9.5.9 1.7 0 2.2l-4.6 2.6L13 12Z" fill="#FFCE00" />
          <path d="M4.7 2 13 12l-9.4 9.7c.3.2.7.2 1.2-.1L16.1 15 4.7 2Z" fill="#00F076" />
          <path d="M16.1 9 4.9 2c-.5-.3-.9-.3-1.2-.1L13 12l3.1-3Z" fill="#FF3A44" />
        </svg>
      ) : (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="#fff">
          <path d="M16.4 1.5c.1 1-.3 2-1 2.8-.7.8-1.8 1.4-2.8 1.3-.1-1 .4-2 1-2.7.8-.8 2-1.4 2.8-1.4ZM19 17c-.5 1.2-.8 1.7-1.4 2.7-.9 1.4-2.1 3.1-3.7 3.1-1.4 0-1.7-.9-3.6-.9s-2.3.9-3.6.9c-1.6 0-2.8-1.6-3.7-3C-.1 16-.5 9.8 2.5 8c1-.6 2.2-.9 3.2-.6 1.1.3 1.8.9 2.7.9.9 0 1.4-.6 2.8-.9 1.7-.4 3.4.2 4.4 1.6-3.9 2.1-3.2 7.6 1.4 8Z" />
        </svg>
      )}
      <span style={{ textAlign: "left", lineHeight: 1.1 }}>
        <span className="mono" style={{ display: "block", fontSize: 9, letterSpacing: "0.1em", color: "var(--fg-3)" }}>
          {isPlay ? "DISPONIBLE EN" : "DESCARGA EN"}
        </span>
...
function PhoneMock() {
  ...
  return (
    <div className="reveal" style={{ position: "relative", justifySelf: "center" }}>
      ...
      <div
        aria-hidden="true"
        style={{ position: "absolute", inset: "-12% -8%", background: "radial-gradient(circle at 50% 40%, rgba(227,30,36,0.30), transparent 65%)", filter: "blur(20px)" }}
      />
      <div
        style={{
      ...
      >
        ...
        <div
          style={{
            ...
            background: "radial-gradient(120% 80% at 50% 0%, #1c0809, #0a0a0a 60%)", position: "relative",
        ...
        >
          ...
          <div className="mono" style={{ display: "flex", justifyContent: "space-between", padding: "13px 22px 0", fontSize: 11, color: "#fff", zIndex: 2 }}>
            ...
            <span style={{ display: "flex", gap: 5 }}>
              <Icon name="signal" size={13} /><Icon name="wifi" size={13} /><Icon name="battery-full" size={13} />
            </span>
          </div>
          {/* app header */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 20px 14px" }}>
            ...
            <span
              style={{
                display: "inline-flex", alignItems: "center", gap: 6, fontSize: 9, fontFamily: "var(--font-mono)", fontWeight: 700,
                color: "#fff", background: "rgba(227,30,36,0.18)", border: "1px solid var(--line-red)", padding: "4px 8px", borderRadius: 999,
              }}
            >
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--red-bright)", animation: "pulse-dot 1.4s infinite" }} />
              EN VIVO
            </span>
          </div>
          {/* big album */}
          <div style={{ padding: "6px 20px 0", flex: 1, display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ fontSize: 13, color: "var(--fg-2)", marginBottom: 14 }}>{nowPlaying.artist}</div>
            {/* progress */}
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 26, marginBottom: 18 }}>
              ...
              <span
                style={{
                  width: 54, height: 54, borderRadius: "50%", background: "linear-gradient(180deg, var(--red-bright), var(--red))",
    ...
    <Section id="megaapp">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="app-grid">
        <div>
          ...
          <h2 className="h2 reveal" style={{ marginBottom: 22 }}>
            La Mega <span style={{ color: "var(--red)" }}>App</span>
          </h2>
          ...
          <div className="reveal" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, maxWidth: 460, marginBottom: 34 }}>
            {APP_FEATURES.map((f) => (
              <div key={f.title} style={{ display: "flex", gap: 13, alignItems: "flex-start" }}>
                <span
                  style={{
                    width: 42, height: 42, flexShrink: 0, borderRadius: "var(--r-sm)", background: "var(--bg-2)",
                    border: "1px solid var(--line-red)", display: "flex", alignItems: "center", justifyContent: "center",
                    boxShadow: "0 0 16px rgba(227,30,36,0.18)",
                  }}
                >
                  <Icon name={f.icon} size={20} color="var(--red-bright)" />
                </span>
                <div>
                  <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15, color: "#fff", textTransform: "uppercase", letterSpacing: "0.02em" }}>
                    {f.title}
                  </div>
